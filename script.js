...
// Monitor Auth State Across Browsers
    ...
    if (user) {
        ...
        if(userNavState) {
            userNavState.innerHTML = `
                <span class="hud-badge-online" style="background:#22c55e; color:white; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:700;">ONLINE</span>
                <span style="font-size:12px; color:#facc15;">${user.email}</span>
                <button id="logoutActionBtn" style="color:#ef4444; font-size:11px; font-weight:700; margin-left:10px; cursor:pointer;">LOGOUT</button>
            `;
